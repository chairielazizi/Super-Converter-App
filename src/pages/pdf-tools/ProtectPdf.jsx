...
const ProtectPdf = () => {
  ...
  const protectPdf = async () => {
    ...
    try {
      ...
      // Encrypt the PDF
      // We set both user and owner password to the same value for simplicity in this "Protect" tool
      // This ensures the file is locked for opening
      pdfDoc.encrypt({
      ...
      const result = await downloadPdf(
        pdfBytes,
        getTimestampedFilename("protected")
      );
  ...
  return (
    <div className="page-container">
      ...
      <header style={{ marginBottom: "20px", textAlign: "center" }}>
        <h2 className="neon-text">Protect PDF</h2>
        <p style={{ color: "#888" }}>Encrypt your PDF with a password</p>
      </header>
            ...
            {!downloadResult ? (
              ...
              <div className="result-section">
                <div className="success-icon-wrapper">
                  ...
                  <Lock size={32} className="success-icon" />
                </div>

                <h3 className="success-title">PDF Protected Successfully!</h3>
                <p className="success-subtitle">
                  Your PDF is now encrypted with the password you set.
                </p>
                ...
                <div className="download-action-area">
                  <div className="file-preview-card">
                    ...
                    <span className="file-name-display">
                      {downloadResult?.filename || "protected.pdf"}
                    </span>
                  </div>
