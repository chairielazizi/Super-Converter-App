  ...
  return (
    <div className="page-container">
      ...
      <header style={{ marginBottom: "20px", textAlign: "center" }}>
        <h2 className="neon-text">Extract PDF Pages</h2>
        <p style={{ color: "#888" }}>
            ...
            {!previewUrl && !downloadResult ? (
              <>
                ...
                >
                  ...
                  {isProcessing
                    ? "Extracting..."
                    : `Extract ${selectedPages.size} Page${
              ...
              <div className="result-section">
                ...
                <h3 className="success-title">Pages Extracted Successfully!</h3>
                <p className="success-subtitle">
                  {selectedPages.size} page{selectedPages.size !== 1 ? "s" : ""}{" "}
                  extracted. Your new PDF is ready.
                </p>
                ...
                <div className="download-action-area">
                  <div className="file-preview-card">
                    ...
                    <span className="file-name-display">
                      {downloadResult?.filename || "extracted-pages.pdf"}
                    </span>
                  </div>
